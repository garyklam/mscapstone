...
def upload_file():
    ...
    if file and allowed_file(file.filename):
        ...
        return render_template('results.html', uploads=app.config['UPLOAD_FOLDER'], filename=filename, features=features, predictions=prediction, conf=conf)
    else:
